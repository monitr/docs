...
The table Budget Accounts contains the following fields:
...
You upload your Budget accounts via CSV or enter them via the user interface via [the tab 'Budget Accounts'](https://app.monitr.be/dashboard/organisations/entities/definitions/budget)
