...
You can either upload a pre-defined template (such as this file) or use tabsheet 'Cash flow' our [google sheets template](/setup/template) to define your Cash flow statement.
