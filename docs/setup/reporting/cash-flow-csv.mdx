...
<Icon iconName="SkypeCheck"/> Name is not empty  
<Icon iconName="SkypeCheck"/> Rank needs to be an integer and unique   
...
1. Make sure the status of all validation rules in the tabsheet 'Cash flow' of the templat is 'TRUE'.
